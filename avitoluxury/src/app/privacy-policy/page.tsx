      ...
      <div className="container mx-auto px-4 py-16 max-w-5xl">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Varnika Enterprises (AVITO LUXURY), Pipli Chowk Maderna Colony behind Mandore, Krishi Mandi, Jodhpur, Rajsthan - 342007.</li>
            ...
            <li><strong>Website</strong> refers to AVITO LUXURY, accessible from <a href="https://www.avitoluxury.in/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">https://www.avitoluxury.in/</a></li>
          ...
          <h4 className="text-lg font-bold mt-4 mb-2">Information from Third-Party Social Media Services</h4>
